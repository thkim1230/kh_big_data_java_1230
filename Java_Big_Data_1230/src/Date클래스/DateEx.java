...
// Date() : 1970년 1월 1일 0시0분0초에서 현재까지의 경과시간으로 시간 계산(msec), 객체를 생성후 사용
// SimpleDateFormat : 운영체제로 부터 얻어진 시간 정보를 우리가 원하는 포맷으로 변경해서 출력함(pattern 매칭을 사용)
public class DateEx {
    public static void main(String[] args) {
        // yyyy : 연도를 4자리로 표현    MM : 월을 2자리로 표현   dd : 일을 2자리로 표현
        // yy : 연도를 2자리로 표현      hh : 12시간제를 의미    HH : 24시간제를 의미
        // mm : 분을 2자리로 표현        W : 월에서 몇번째 주    w : 연에서 몇번째
