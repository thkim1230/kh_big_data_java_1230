...
// synchronized (동기화) : 멀티 스레드에서 특정 메소드나 블록{}에 대한 lock(잠금) 을 설정 하는 것
// 동시 접근으로 인해 발생할 수 있는 문제를 해결하기 위해 사용되며, 사용 시 급격한 성능 저하가 발생 할 수 있음
public class ThreadEx7 {
    public static void main(String[] args) {
        ...
        // Runnable 인터페이스를 람다식으로 익명의 스레드 생성
        Runnable th2 = () -> {
